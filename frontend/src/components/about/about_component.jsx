        ...
        <div className="jamie">
          ...
          <div className="social">
            <a className="github" href="https://github.com/HowDidIGitHere">
              <img src="https://res.cloudinary.com/de8carnhu/image/upload/v1638510015/githubicon_w6ympq.png" alt=""/>
            </a>
            <a className="linkedin" href="https://www.linkedin.com/in/jamie-an-6b9b41114/">
              <img src="https://res.cloudinary.com/de8carnhu/image/upload/v1638510015/linkedinbutton_r8xeco.png" alt=""/>
            </a>
          </div>
        </div>
